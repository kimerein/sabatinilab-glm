...
def holdout_splits(dfrel_setup, wi_trial_keep, id_cols=['nTrial'], perc_holdout=0.2):
    '''
    ...
    return dfrel_setup, dfrel_holdout, wi_trial_keep_tr, wi_trial_keep_holdout
...
for left_out in leave_one_out_list:
    ...
    for y_col in ['zsrdFF', 'zsgdFF']:
        ...
        for filename in files_list:
            ...
            dfrel = dfrel.dropna()
            wi_trial_keep = get_is_not_iti(dfrel)
            dfrel_setup, dfrel_holdout, wi_trial_keep_tr, wi_trial_keep_holdout = holdout_splits(dfrel,
                                                                                                wi_trial_keep,
                                                                                                id_cols=['nTrial'],
                                                                                                perc_holdout=0.2)
